(() => {
      ...
      (function(global, factory) {
        ...
        var _config = {
          ...
          if (_windowExists() || config.headless) {
            ...
            config.register && config.register(gsap3, Plugin, PropTween);
          } else {
            ...
            wake: function wake() {
              if (_coreReady) {
                if (!_coreInitted && _windowExists()) {
                  ...
                  _doc = _win.document || {};
                  _globals.gsap = gsap3;
                  (_win.gsapVersions || (_win.gsapVersions = [])).push(gsap3.version);
  ...
  // src/scripts/animations/loadAnimation.js
  var { default: gsap } = require_gsap();
  var loadAnimation = (callback) => {
  ...
  var loadAnimation_default = loadAnimation;

  // src/scripts/animations/circleAnimation.js
  var import_gsap = __toESM(require_gsap());
  var circleAnimation = () => {
    import_gsap.default.to(".circle", {
      scale: 1.5,
      y: 50
    });
  };
  var circleAnimation_default = circleAnimation;

  // src/scripts/app.js
  var afterLoadAnimation = () => {
    circleAnimation_default();
  };
  loadAnimation_default(afterLoadAnimation);
})();
