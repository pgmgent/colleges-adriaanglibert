(() => {
  ...
  var box_default = initBoxAnimation;

  // src/scripts/animations/circle.js
  var scaleAnimation = gsapWithCSS.to(".circle", {
    scale: 0.5,
    paused: true
  });
  var moveAnimation = gsapWithCSS.to(".circle", {
    x: 500,
    paused: true
  });
  var initCircleAnimation = () => {
    ...
    mm.add("(min-width: 500px)", () => {
      ...
      console.log(context3.conditions);
      const { isMobile, isDesktop } = context3.conditions;
      gsapWithCSS.to(".circle", {
        scale: isMobile ? 2 : isDesktop ? 4 : 1
      });
    });
  };
  var circle_default = initCircleAnimation;
